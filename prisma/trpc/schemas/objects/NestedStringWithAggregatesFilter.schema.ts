...
z.lazy(() => NestedStringWithAggregatesFilterObjectSchema)]) .optional(),
...
z.lazy(() => NestedStringWithAggregatesFilterObjectSchema)]) .optional(),  _count: z.object(NestedIntFilterSchemaObject).optional(),  _min: z.object(NestedStringFilterSchemaObject).optional(),  _max: z.object(NestedStringFilterSchemaObject).optional()
});
