...
export const PostFindManySchema = z.object({ where: z.object(PostWhereInputSchemaObject), orderBy: z.object(PostOrderByWithRelationInputSchemaObject), cursor: z.object(PostWhereUniqueInputSchemaObject), take: z.number(), skip: z.number(), distinct: z.array(PostScalarFieldEnumSchema)  })